...
function Sidebar() {
    ...
    return (
        <nav onClick={() => setShow(v => !v)} className={`absolute z-20 top-38 ${show ? "max-md:-left-0" : "max-md:-left-14"} sidebar-transition py-6 pl-4 pr-6 rounded-r-2xl background-connexion`}>
